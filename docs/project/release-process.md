...
- Confirm the packaged app shows `0.2.3` metadata.
...
- Download the native-package, Koffi prune/smoke, and updater metadata manifests.
  ...
  listed artifact filename identify `0.2.3`.
...
- Settings -> About shows `v0.2.3`, sourced from `app.getVersion()`.
