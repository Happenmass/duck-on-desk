...
- Confirm the packaged app shows `0.2.0` metadata.
...
- Download the native-package, Koffi prune/smoke, and updater metadata manifests.
  ...
  listed artifact filename identify `0.2.0`.
...
- Settings -> About shows `v0.2.0`, sourced from `app.getVersion()`.
