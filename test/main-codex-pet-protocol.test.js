...
test("package metadata registers the duck protocol and exposes dev registration", () => {
  ...
  assert.ok(protocols.some((entry) => Array.isArray(entry.schemes) && entry.schemes.includes("duck")));
