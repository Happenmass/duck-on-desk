...
const { validateTheme } = require("../src/theme-schema");
...
test("visual projection accepts the duck3d channel", () => {
  const src = fs.readFileSync(path.join(__dirname, "..", "src", "displayed-visual-projection.js"), "utf8");
...
test("theme loader skips asset existence checks for duck3d themes", () => {
  const src = fs.readFileSync(path.join(__dirname, "..", "src", "theme-loader.js"), "utf8");
