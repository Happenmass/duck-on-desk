...
// Consumed by src/state/claude-settings-watcher.js's periodic audit and by
// src/shell/doctor-detectors/agent-integrations.js for on-demand diagnostics. Never
...
const {
  validateHookCommand,
} = require("../shell/doctor-detectors/agent-node-bin-parser");
const {
