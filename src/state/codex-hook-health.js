...
const { checkAgentIntegrations } = require("../shell/doctor-detectors/agent-integrations");
const { getAgentDescriptors } = require("../shell/doctor-detectors/agent-descriptors");
