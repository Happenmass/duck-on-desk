...
// a source only. Provider sections cover Claude Code's rate_limits, Codex's
// generic rollout rate_limits, and Dashboard-only Codex Spark quota.
...
// One row per source that has live data for the provider. Source labels appear only when they carry information: a single
