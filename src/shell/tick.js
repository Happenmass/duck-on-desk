// src/shell/tick.js — Main tick loop (cursor polling, eye tracking, idle/sleep detection, mini peek)
...
function sendPointerBridge(cursor, bounds) {
  ...
  const payload = {
    x: raw.x,
    y: raw.y,
    // Duck polls the global cursor, so pointer-aware Cloudling idle states
