...
const { normalizeSessionAliases } = require("../state/session-alias");
const {
  TEXT_SCALE_MIN,
  TEXT_SCALE_MAX,
  TEXT_SCALE_DEFAULT,
...
const SCHEMA = {
  ...
  // Pure data prefs
  lang: { type: "string", default: "en", enum: ["en", "zh", "zh-TW"] },
  ...
  petRobot: { type: "string", default: "duck", enum: ["duck", "reachy-mini"] },
  reachyAutoConnect: { type: "boolean", default: true },
  // Physical expressions: the daemon's own recorded moves, played while
