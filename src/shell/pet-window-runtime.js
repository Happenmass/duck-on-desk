...
function createPetWindowRuntime(options = {}) {
  ...
  // MUST NOT change: src/robots/duck/roam.js:104-105, src/shell/tick.js:236-238 and
  // src/shell/pet-interaction-ipc.js:121-124 all depend on this null to no-op
  ...
  // Shared src/shell/display-edge.js topology resolver (plan §4.1), scoped to a
  ...
  // (src/shell/styles.css) — an |offsetX| that reaches the window width clips the
  ...
  // sites (src/shell/pet-interaction-ipc.js's drag-lock(false) branch and its
