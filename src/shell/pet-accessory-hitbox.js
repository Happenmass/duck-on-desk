...
const BUILTIN_ACCESSORY_MOTION_PADDING = Object.freeze({
  duck: Object.freeze({
    "duck-about-hero.svg": Object.freeze({ left: 0.4, right: 0.4 }),
    "duck-aegyo-shy.svg": Object.freeze({ left: 1.2, right: 0.5, bottom: 1.4 }),
    "duck-coffee-hand.svg": Object.freeze({ left: 0.5, top: 0.4, right: 0.5, bottom: 0.4 }),
    "duck-idle-follow.svg": Object.freeze({ left: 0.2, right: 0.2, bottom: 0.7 }),
    "duck-dizzy.svg": Object.freeze({ left: 2, top: 0.5, right: 2, bottom: 0.6 }),
    "duck-happy.svg": Object.freeze({ top: 12, bottom: 1.5 }),
    "duck-idle-living.svg": Object.freeze({ left: 1.2, top: 4, right: 1.2, bottom: 2 }),
    "duck-idle-low-battery.svg": Object.freeze({ left: 0.7, right: 0.7, bottom: 2.3 }),
    "duck-idle-look.svg": Object.freeze({ left: 1.2, right: 1.2, bottom: 0.7 }),
    "duck-idle-yawn.svg": Object.freeze({ left: 0.8, top: 4.5, right: 0.8, bottom: 2 }),
    "duck-mini-idle.svg": Object.freeze({ left: 3.2, top: 1.6, right: 0.2, bottom: 2.4 }),
    "duck-mini-alert.svg": Object.freeze({ left: 3.2, top: 1.6, right: 0.2, bottom: 2.4 }),
    "duck-mini-happy.svg": Object.freeze({ left: 3.2, top: 1.6, right: 0.2, bottom: 2.4 }),
    "duck-mini-peek.svg": Object.freeze({ left: 3.2, top: 1.6, right: 0.2, bottom: 2.4 }),
    "duck-mini-typing.svg": Object.freeze({ left: 3.2, top: 1.6, right: 0.2, bottom: 2.4 }),
    "duck-mini-crabwalk.svg": Object.freeze({ left: 1.8, right: 3.9, bottom: 1.3 }),
    "duck-mini-enter.svg": Object.freeze({ left: 6.2, top: 2.4, right: 25, bottom: 2.1 }),
    "duck-working-thinking.svg": Object.freeze({ left: 1.6, top: 0.2, right: 1.6, bottom: 0.8 }),
    "duck-working-typing.svg": Object.freeze({ bottom: 1.5 }),
    "duck-working-typing-boss.svg": Object.freeze({ left: 0.5, top: 0.3, right: 0.5, bottom: 0.8 }),
    "duck-working-ultrathink.svg": Object.freeze({ left: 0.5, top: 0.1, right: 0.6, bottom: 0.1 }),
    "duck-notification.svg": Object.freeze({ left: 1.7, top: 0.6, bottom: 0.6 }),
    "duck-working-building.svg": Object.freeze({ bottom: 5 }),
    "duck-working-juggling.svg": Object.freeze({ left: 1.4, top: 0.2, right: 1.4, bottom: 1.4 }),
    "duck-idle-bubble.svg": Object.freeze({ top: 1.2, bottom: 0.7 }),
    "duck-idle-reading.svg": Object.freeze({ left: 0.2, right: 0.2, bottom: 1.1 }),
    "duck-idle-doze.svg": Object.freeze({ left: 0.7, right: 0.7, bottom: 2.3 }),
    "duck-react-drag.svg": Object.freeze({ left: 1.8, top: 0.4, right: 1.8, bottom: 0.5 }),
    "duck-react-left.svg": Object.freeze({ left: 2.9, top: 0.3, bottom: 0.3 }),
    "duck-react-right.svg": Object.freeze({ top: 0.3, right: 2.9, bottom: 0.3 }),
    "duck-react-annoyed.svg": Object.freeze({ top: 0.8, right: 2, bottom: 1.5 }),
    "duck-react-double.svg": Object.freeze({ left: 1, top: 1, right: 1 }),
    "duck-react-double-jump.svg": Object.freeze({ left: 0.9, top: 3.6, right: 0.9, bottom: 1.8 }),
    "duck-working-sweeping.svg": Object.freeze({ left: 3.6, top: 0.9, right: 0.1, bottom: 1.6 }),
    "duck-working-carrying.svg": Object.freeze({ left: 0.9, top: 0.3, bottom: 1.3 }),
    "duck-working-debugger.svg": Object.freeze({ left: 1.8, right: 4, bottom: 2 }),
    "duck-sleeping.svg": Object.freeze({ left: 0.2, top: 5.3, right: 0.2 }),
  }),
...
const BUILTIN_MOUTH_ACCESSORY_MOTION_PADDING = Object.freeze({
  duck: Object.freeze({
    "duck-about-hero.svg": Object.freeze({ left: 0.2, top: 0.2, right: 0.2, bottom: 0.2 }),
    "duck-coffee-hand.svg": Object.freeze({ left: 0.5, top: 0.4, right: 0.5, bottom: 0.4 }),
    "duck-coffee-head-flip.svg": Object.freeze({ top: 1.6, right: 0.4, bottom: 0.4 }),
    "duck-idle-follow.svg": Object.freeze({ right: 0.2, bottom: 0.5 }),
    "duck-idle-yawn.svg": Object.freeze({ left: 0.4, top: 3.1, right: 0.7, bottom: 1.5 }),
    "duck-idle-doze.svg": Object.freeze({ right: 0.8, bottom: 1.7 }),
    "duck-idle-living.svg": Object.freeze({ left: 1, top: 2.8, right: 1.2, bottom: 1.4 }),
    "duck-idle-low-battery.svg": Object.freeze({ right: 0.8, bottom: 1.7 }),
    "duck-working-thinking.svg": Object.freeze({ left: 0.9, top: 0.2, right: 1, bottom: 0.7 }),
    "duck-working-typing.svg": Object.freeze({ right: 0.2, bottom: 1.3 }),
    "duck-working-ultrathink.svg": Object.freeze({ left: 0.5, top: 0.1, right: 0.6, bottom: 0.1 }),
    "duck-working-wizard.svg": Object.freeze({ left: 3, right: 3.4, bottom: 1.4 }),
    "duck-headphones-groove.svg": Object.freeze({ left: 1, top: 0.6, right: 0.9, bottom: 1.3 }),
    "duck-notification.svg": Object.freeze({ left: 0.5, top: 0.2, right: 0.5, bottom: 0.3 }),
    "duck-working-carrying.svg": Object.freeze({ left: 0.4, top: 0.4, bottom: 0.9 }),
    "duck-wake.svg": Object.freeze({ left: 1.5, top: 6.4, right: 0.4, bottom: 4.1 }),
    "duck-dizzy.svg": Object.freeze({ left: 1.2, top: 0.6, right: 1.2, bottom: 0.6 }),
    "duck-working-juggling.svg": Object.freeze({ left: 0.6, top: 0.2, right: 0.7, bottom: 1.3 }),
    "duck-idle-look.svg": Object.freeze({ left: 1, right: 1.2, bottom: 0.5 }),
    "duck-idle-reading.svg": Object.freeze({ right: 0.2, bottom: 0.9 }),
    "duck-react-left.svg": Object.freeze({ left: 2.4, top: 0.4 }),
    "duck-react-right.svg": Object.freeze({ right: 2.4, bottom: 0.4 }),
    "duck-react-annoyed.svg": Object.freeze({ top: 0.6, right: 2, bottom: 1.5 }),
    "duck-react-double.svg": Object.freeze({ left: 1, top: 1, right: 1 }),
    "duck-react-double-jump.svg": Object.freeze({ left: 0.5, top: 4, right: 0.9, bottom: 1 }),
  }),
});
