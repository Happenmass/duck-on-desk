...
(`anthonyonazure`) and Oscar in [PR #811](https://github.com/rullerzhou-afk/duck-on-desk/pull/811)
...
- `duck-outlaw-bender.svg` is the unmodified author-provided 15-second bender
...
The full generated Outlaw theme is not shipped. The existing Duck sprites and
